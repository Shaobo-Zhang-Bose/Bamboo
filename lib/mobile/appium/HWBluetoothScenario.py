...
from wham_automation.test_scripts.Bamboo.lib.mobile.constants import HUAWEIConstant
from wham_automation.lib.mobile.scenario.PhoneInfo import PhoneInfo


class HWBluetoothScenario(BasePage, BluetoothInterface):
    def __init__(self, android_locators=HUAWEIConstant,
    ...
    def __initialize_variable_of_bluetooth(self):
        ...
        if self.phone_info.phone_type == PhoneType.ANDROID:
            self.package_name = HUAWEIConstant.bluetooth_settings_app_package
            self.activity_name = HUAWEIConstant.bluetooth_app_activity
