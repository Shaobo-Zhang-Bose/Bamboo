...
###
###  VIVOConstant contains All UI locators constants of VIVO mobile
###
###
################################################################################
...
bluetooth_app_activity = 'com.android.settings.Settings$ExtraNetworkConnectionActivity'
...
SETTINGS_NETWORKS_AND_CONNECTIONS_TAB_ByXPATH = '//android.widget.TextView[@text="Other Networks and Connections"]'
...
BLUETOOTH_ON_OFF_CHECK_ByXPATH = '//android.widget.Switch[@resource-id="android:id/checkbox"]'

PAIRED_DEVICES_SHOW_MORE_LESS_ByID = 'com.android.settings:id/tv_show_title'

BLUETOOTH_CONNECTED_DEVICE_LIST_ByXPATH = '//android.widget.TextView[contains(@text,"Connected")]/' \
                                          'preceding-sibling::android.widget.TextView[@resource-id="android:id/title"]'

BLUETOOTH_PAIRED_DEVICE_LIST_ByXPATH = '//android.widget.ImageView[@resource-id="com.android.bluetoothsettings:id/deviceDetails"]'

BLUETOOTH_PAIRED_DEVICE_TEXT_ByXPATH = '//android.widget.ImageView[@resource-id="com.android.bluetoothsettings:id/deviceDetails"]' \
                          '/../../descendant-or-self::android.widget.RelativeLayout/android.widget.TextView[@resource-id="android:id/title"]'
...
BLUETOOTH_CONNECTED_INDICATOR_ByXPATH = '//android.widget.TextView[contains(@text, "Connected")]'
#################################################################################################
