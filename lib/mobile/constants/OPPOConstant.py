...
### @brief           OPPOConstant
### @author          Xinyu Cao
### @date            Creation Date: July 8th, 2020
###
###  OPPOConstant contains All UI locators constants of OPPO mobile
###
###
################################################################################
...
PERMIT_XPATH = '//android.widget.Button[@resource-id="com.android.permissioncontroller:id/permission_allow_button1"]'
INSTALL_XPATH = '//android.widget.Button[contains(@text,"安装")]'
# *** added by Xinyu *** end
android_settings_app_package = 'com.android.settings'
android_settings_app_activity = 'com.android.settings.Settings'

bluetooth_settings_app_package = 'com.android.settings'
bluetooth_app_activity = 'com.android.settings.Settings'
...
phone_permission_allow_ByXPATH = '//android.widget.Button[@resource-id="com.android.permissioncontroller:id/permission_allow_button_1"]'
storage_permission_allow_ByXPATH = '//android.widget.Button[@resource-id="com.android.permissioncontroller:id/permission_allow_button_1"]'
record_permission_allow_ByXPATH = '//android.widget.Button[@resource-id="com.android.permissioncontroller:id/permission_allow_button_1"]'
permission_allow_ByXPATH = '//android.widget.Button[contains(@text,"ALLOW")]'

OK_BUTTON_ByXPATH = '//android.widget.Button[@text="OK"]'
...
BLUETOOTH_ON_OFF_ByID = 'com.coloros.wirelesssettings:id/switchWidget'

BLUETOOTH_ON_OFF_CHECK_ByXPATH = '//android.widget.Switch[@resource-id="com.coloros.wirelesssettings:id/switchWidget"]'

PAIRED_DEVICES_SHOW_MORE_LESS_ByID = 'com.android.settings:id/tv_show_title'

BLUETOOTH_CONNECTED_DEVICE_LIST_ByXPATH = '//android.widget.TextView[contains(@text,"In use")]/parent::android.widget.RelativeLayout' \
                                         '//android.widget.TextView[@resource-id="android:id/title"]'

BLUETOOTH_PAIRED_DEVICE_LIST_ByXPATH = '//android.widget.ImageView[@resource-id="com.coloros.wirelesssettings:id/deviceDetails"]'

PAIRED_DEVICE_TEXT_ByXPATH = '//android.widget.ImageView[@resource-id="com.coloros.wirelesssettings:id/deviceDetails"]' \
                          '/../../preceding-sibling::android.widget.RelativeLayout/android.widget.TextView[@resource-id="android:id/title"]'
...
BLUETOOTH_CONNECTED_INDICATOR_ByXPATH = '//android.widget.TextView[contains(@text, "In use")]'
#################################################################################################

BLUETOOTH_ON_OFF_8_0_0_ByXPATH = '//android.widget.Switch'
SETTINGS_BT_TAB_ByXPATH = '//android.widget.TextView[@text="Bluetooth"]'

BLUETOOTH_CONNECTION_SETTINGS_ByID = 'com.coloros.wirelesssettings:id/deviceDetails'
DO_NOT_ASK_AGAIN_CHECKBOX_ByXPATH = '//android.widget.CheckBox[@resource-id="com.coloros.wirelesssettings:id/color_security_alertdailog_checkbox"]'
...
BLUETOOTH_DEVICE_SETTINGS_BUTTON_6_0_1_ByID = \
    'com.coloros.wirelesssettings:id/deviceDetails'
