#############################################################################
### @brief           XIAOMIConstant
### @author          Hua Xu
### @date            Creation Date: 20/04/2020
###
...
HOMEPAGE_SEARCH_BAR_XPATH = '//com.android.browser[@resource-id="com.android.browser:id/search_hint"]'
ALLOW_ALWAYS_XPATH = '//android.widget.Button[@resource-id="com.lbe.security.miui:id/permission_allow_always_button"]'
...
ALLOW_XPATH = '//android.widget.Button[@resource-id="com.lbe.security.miui:id/permission_allow_button_1"]'
# *** added by Xinyu *** end
android_settings_app_package = 'com.android.settings'
android_settings_app_activity = 'com.android.settings.MiuiSettings'
...
location_permission_allow_always_ByXPATH = '//android.widget.Button[@resource-id="com.lbe.security.miui:id/permission_allow_always_button"]'
phone_permission_allow_ByXPATH = '//android.widget.Button[@resource-id="com.lbe.security.miui:id/permission_allow_button_1"]'
storage_permission_allow_ByXPATH = '//android.widget.Button[@resource-id="com.lbe.security.miui:id/permission_allow_button_1"]'
record_permission_allow_ByXPATH = '//android.widget.Button[@resource-id="com.lbe.security.miui:id/permission_allow_button_1"]'
...
# BLUETOOTH_ON_OFF_ByXPATH = '//android.widget.TextView[@text="Bluetooth"]/parent::android.widget.RelativeLayout/following-sibling::android.widget.TextView[@text="On"]'

BLUETOOTH_ON_OFF_ByID = 'android:id/checkbox'

BLUETOOTH_ON_OFF_CHECK_ByXPATH = '//android.widget.CheckBox[@resource-id="android:id/checkbox"]'

PAIRED_DEVICES_SHOW_MORE_LESS_ByID = 'com.android.settings:id/tv_show_title'

BLUETOOTH_CONNECTED_DEVICE_LIST_ByXPATH = '//android.widget.TextView[contains(@text,"Connected") or contains(@text,"Active")]' \
                                          '/preceding-sibling::android.widget.FrameLayout/descendant-or-self::android.widget.TextView[@resource-id="android:id/title"]'

# BLUETOOTH_PAIRED_DEVICE_LIST_ByXPATH = '//android.widget.ImageView[@resource-id="com.android.settings:id/deviceDetails"]'

BLUETOOTH_PAIRED_DEVICE_LIST_ByXPATH = '//android.widget.ImageView[@resource-id="com.android.settings:id/preference_detail"]'


# PAIRED_DEVICE_TEXT_ByXPATH = '//android.widget.ImageView[@resource-id="com.android.settings:id/deviceDetails"]/../../preceding-sibling::android.widget.RelativeLayout/android.widget.FrameLayout/android.widget.TextView'

PAIRED_DEVICE_TEXT_ByXPATH = '//android.widget.ImageView[@resource-id="com.android.settings:id/preference_detail"]/../preceding-sibling::android.widget.RelativeLayout/android.widget.FrameLayout/android.widget.TextView'
...
BLUETOOTH_AVAILABLE_DEVICE_LIST_ByXPATH = '//android.widget.ImageView[@resource-id="com.android.settings:id/preference_detail"]'

BLUETOOTH_UNPAIR_BUTTON_ByXPATH = '//android.widget.TextView[@text="Unpair"]'

BLUETOOTH_CONNECT_DEVICE_ByXPATH = '//android.widget.TextView[@text="Paired ' \
                                   'devices" or @text="Available devices" or ' \
                                   '@text="AVAILABLE DEVICES" or ' \
                                   '@text="PAIRED ' \
                                   'DEVICES"]/following::android.widget.LinearLayout/descendant-or-self::android.widget.RelativeLayout/descendant-or-self::android.widget.TextView'

# BLUETOOTH_PAIR_NEW_DEVICE_REFRESH_ByXPATH = '//android.widget.Button[@text="Refresh"]'
BLUETOOTH_PAIR_NEW_DEVICE_REFRESH_ByXPATH = '//android.widget.ImageView[@resource-id="com.android.settings:id/refresh_anim"]'
...
BLUETOOTH_CANCEL_PAIR_BUTTON_ByXPATH = '//android.widget.Button[@resource-id="android:id/button2"]'
BLUETOOTH_PAIR_FAILED_BUTTON_ByXPATH = '//android.widget.Button[@text="OK"]'
BLUETOOTH_DEVICE_NAME_CANCEL_BUTTON_ByXPATH = '//android.widget.Button[@resource-id="android:id/button1"]'
...
BLUETOOTH_ANDROID_9_PAIRED_DEVICE_LIST_ByXPATH = '//android.widget.TextView[' \
                                                 '@content-desc= "Help & ' \
                                                 'feedback"]/following::android.widget.TextView'
...
CLEAR_NOTIFICATION_ByXPATH = '//android.view.View[@resource-id="com.android.systemui:id/dismiss_view"]'
